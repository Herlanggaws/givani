...
class CustsomerController extends Controller
{
    /**
    ...
    public function store(CustomerRequest $request)
    {
        try {
            ...
            return redirect('customer')->with('message', 'Data dengan email tersebut sudah digunakan!'.$e->getMessage());
